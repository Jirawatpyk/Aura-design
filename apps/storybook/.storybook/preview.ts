...
const preview: Preview = {
  ...
  parameters: {
    ...
    layout: 'fullscreen',
    options: { storySort: { order: ['Welcome', 'AURA', ['Actions', 'Forms', 'Feedback', 'Pickers', 'Overlays', 'Data', 'Layout', 'Responsive'], 'Props', ['Actions', 'Forms', 'Pickers', 'Feedback', 'Overlays', 'Data', 'Layout', 'Theming and locale']] } },
  },
};
