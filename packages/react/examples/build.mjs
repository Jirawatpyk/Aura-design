 ...
 *   node examples/build.mjs            all examples
 *   node examples/build.mjs settings   one */
...
for (const name of names) {
  ...
  const common = { entryPoints: [path.join(dir, 'main.jsx')], bundle: true, jsx: 'transform', target: 'es2019', write: false, logLevel: 'error', nodePaths: [path.join(pkg, 'node_modules')] };
