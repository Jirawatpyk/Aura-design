...
const STATUS_TH = { Backlog: 'รอยืนยัน', 'In Progress': 'กำลังดำเนินการ', Ready: 'เสร็จสิ้น', Blocked: 'ยกเลิก' };
export const statusLabel = (s) => STATUS_TH[s] || s;
export const TONE = { 'รอยืนยัน': 'neutral', 'กำลังดำเนินการ': 'progress', 'เสร็จสิ้น': 'ready', 'ยกเลิก': 'blocked' };
