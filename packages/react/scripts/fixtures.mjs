...
export function fixtures(A, React) {
  ...
  return {
    ...
    ComboboxMultiple: h(A.Combobox, { multiple: true, label: 'Tags', options: ['VIP', 'Urgent', 'Weekend'], defaultValue: ['VIP', 'Weekend'], name: 'tags' }),
    NumberField: h(A.NumberField, { label: 'ราคา', prefix: '฿', defaultValue: 12500, min: 0 }),
    Stepper: h(A.Stepper, { label: 'Booking', current: 'b', steps: [{ id: 'a', label: 'Service' }, { id: 'b', label: 'Time' }, { id: 'c', label: 'Confirm' }], onStepClick: noop }),
