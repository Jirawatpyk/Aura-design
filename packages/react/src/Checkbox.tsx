...
export const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(function Checkbox(props, ref) {
  var own = React.useRef<HTMLInputElement | null>(null), merged = useMergedRef(ref, own);
  ...
  return h('label', { className: cx('aura-check', labelled && 'aura-check--labelled', props.disabled && 'is-disabled', props.className), onClick: function (e: React.MouseEvent) { e.stopPropagation(); } },
    h('input', Object.assign({}, rest, { ref: merged, type: 'checkbox', className: 'aura-check__input', checked: on,
      ...
      'aria-label': labelled ? undefined : props.label, onChange: function (e: React.ChangeEvent<HTMLInputElement>) { st[1](e.target.checked); } })),
