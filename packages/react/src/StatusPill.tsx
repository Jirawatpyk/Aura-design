...
var TONE_ICON: Record<StatusTone, IconName> = { neutral: 'circle', progress: 'circle-dot-dashed', ready: 'circle-check', blocked: 'ban' };
var TONE_WORDS: Record<Exclude<StatusTone, 'neutral'>, string[]> = {
...
export function toneFor(status: unknown): StatusTone {
  ...
  for (var t in TONE_WORDS) if (TONE_WORDS[t as keyof typeof TONE_WORDS].indexOf(s) >= 0) return t as StatusTone;
  return 'neutral';
}
export { toneFor as statusTone };
export var TONE_ORDER: Record<StatusTone, number> = { neutral: 0, progress: 1, ready: 2, blocked: 3 };
